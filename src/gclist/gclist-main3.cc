...
int main(){
    ...
    // =========================================================
    // === PARTE NUEVA: EJERCICIO 2 DE LA PRÁCTICA 6 ===========
    // =========================================================

    std::cout << "Normalizando delays respecto al lider..."<< std::endl;

    gc.NormalizeDelays();

    std::cout << "=== Clasificación General NORMALIZADA (Top 10) ===" << std::endl;
    std::cout << gc.GetClassification(10) << std::endl;
